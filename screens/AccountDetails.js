...
const contentStyles = require('../assets/website/style');
// const siteContent = require('../assets/website/index.html');
// const siteContent = () => {
//   console.log('called');
//   return fetch('../assets/website/index.html').then((response) => {
...
export default class AccountDetails extends React.Component {
  componentDidMount() {
    console.log('Dashboard Launched', contentStyles.default);
  }
  ...
  siteContent() {
    return (
      ...
      <body class="">
          ...
          <!-- loader -->
          <!-- <div id="loader" style="opacity: 0.03125; display: none;">
              <img src="./logo-icon.png" alt="icon" class="loading-icon">
          </div> -->
          <!-- * loader -->
          ...
          <div id="appCapsule">
              ...
              <div class="section wallet-card-section pt-1">
                  <div class="wallet-card">
                      ...
                      <div class="balance">
                          ...
                          <a href="../assets/website/style.css">checkMe</a>
                          </div>
                          <div class="right">
                          ...
                          <div class="item">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#withdrawActionSheet">
                                  <div class="icon-wrapper bg-danger">
                                      <ion-icon name="arrow-down-outline" role="img" class="md hydrated"
                          ...
                          <div class="item">
                              <a href="app-cards.html">
                                  <div class="icon-wrapper bg-success">
                                      <ion-icon name="card-outline" role="img" class="md hydrated" aria-label="card outline">
                                      </ion-icon>
                                  </div>
                                  <strong>Cards</strong>
                              </a>
                          ...
                          <div class="item">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#exchangeActionSheet">
                                  <div class="icon-wrapper bg-warning">
                                      <ion-icon name="swap-vertical" role="img" class="md hydrated"
                                          aria-label="swap vertical"></ion-icon>
                                  </div>
              ...
              <div class="modal fade action-sheet" id="depositActionSheet" tabindex="-1" aria-hidden="true"
                  style="display: none;">
              ...
              <div class="section full mt-4">
                  ...
                  <div class="carousel-single splide splide--loop splide--ltr splide--draggable is-active" id="splide01"
                      ...
                      <div class="splide__track" id="splide01-track" style="padding-left: 16px; padding-right: 16px;">
                          <ul class="splide__list" id="splide01-list" style="transform: translateX(-2588px);">
      
                              <li class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1"
                                  style="margin-right: 16px; width: 434px;">
                                  <!-- card block -->
                                  <div class="card-block bg-primary">
                                      <div class="card-main">
                                          <div class="card-button dropdown">
                                              <button type="button" class="btn btn-link btn-icon" data-bs-toggle="dropdown">
                                                  <ion-icon name="ellipsis-horizontal" role="img" class="md hydrated"
                                              ...
                                              <div class="dropdown-menu dropdown-menu-end">
                                                  <a class="dropdown-item" href="javacript:;">
                                                      <ion-icon name="pencil-outline" role="img" class="md hydrated"
                                                          aria-label="pencil outline"></ion-icon>Edit
                                                  </a>
                                                  <a class="dropdown-item" href="javacript:;">
                                                      <ion-icon name="close-outline" role="img" class="md hydrated"
                                                          aria-label="close outline"></ion-icon>Remove
                                                  </a>
                                                  <a class="dropdown-item" href="javacript:;">
                                                      <ion-icon name="arrow-up-circle-outline" role="img" class="md hydrated"
                                                          aria-label="arrow up circle outline"></ion-icon>Upgrade
                                                  </a>
                                              </div>
                                          </div>
                                          <div class="balance">
                              ...
                              <li class="splide__slide splide__slide--clone" style="margin-right: 16px; width: 434px;">
                                  <!-- card block -->
                                  <div class="card-block bg-primary">
                                      <div class="card-main">
                                          <div class="card-button dropdown">
                              ...
                              <li class="splide__slide is-active is-visible" id="splide01-slide01" aria-hidden="false"
                                  tabindex="0" style="margin-right: 16px; width: 434px;">
                                  <!-- card block -->
                                  <div class="card-block bg-primary">
                                      <div class="card-main">
                                          <div class="card-button dropdown">
                              ...
                              <li class="splide__slide is-visible" id="splide01-slide02" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 434px;">
                                  <!-- card block -->
                                  <div class="card-block bg-dark">
                                      <div class="card-main">
                              ...
                              <li class="splide__slide is-visible" id="splide01-slide03" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 434px;">
                                  <!-- card block -->
                                  <div class="card-block bg-secondary">
                                      <div class="card-main">
              ...
              <div class="section full mt-4">
                  ...
                  <!-- carousel small -->
                  <div class="carousel-small splide splide--loop splide--ltr splide--draggable is-active" id="splide04"
                      style="visibility: visible;">
                      <div class="splide__track" id="splide04-track" style="padding-left: 16px; padding-right: 16px;">
                          <ul class="splide__list" id="splide04-list" style="transform: translateX(-2580px);">
                              <li class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                              ...
                              <li class="splide__slide splide__slide--clone" style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar2.jpg" alt="img" class="imaged w-100">
                                          <strong>Jurrien</strong>
                              ...
                              <li class="splide__slide is-active is-visible" id="splide04-slide01" aria-hidden="false"
                                  tabindex="0" style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar2.jpg" alt="img" class="imaged w-100">
                                          <strong>Jurrien</strong>
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide02" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar3.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide03" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar4.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide04" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar5.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide05" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar6.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide06" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar7.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide07" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar8.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide08" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar9.jpg" alt="img" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide04-slide09" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 134px;">
                                  <a href="#">
                                      <div class="user-card">
                                          <img src="assets/img/sample/avatar/avatar10.jpg" alt="img" class="imaged w-100">
              ...
              <div class="section full mt-4">
                  ...
                  <!-- carousel multiple -->
                  <div class="carousel-multiple splide splide--loop splide--ltr splide--draggable is-active" id="splide02"
                      style="visibility: visible;">
                      <div class="splide__track" id="splide02-track" style="padding-left: 16px; padding-right: 16px;">
                          <ul class="splide__list" id="splide02-list" style="transform: translateX(-2628px);">
      
                              <li class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      ...
                                      <div class="img-wrapper">
                                          <div class="iconbox bg-danger">
                                              <ion-icon name="medkit-outline" role="img" class="md hydrated"
                                                  aria-label="medkit outline"></ion-icon>
                                          </div>
                                      </div>
                              ...
                              <li class="splide__slide splide__slide--clone" style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      <div class="img-wrapper">
                                          <img src="assets/img/sample/brand/1.jpg" alt="img" class="image-block imaged w48">
                                      </div>
                              ...
                              <li class="splide__slide is-active is-visible" id="splide02-slide01" aria-hidden="false"
                                  tabindex="0" style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      <div class="img-wrapper">
                                          <img src="assets/img/sample/brand/1.jpg" alt="img" class="image-block imaged w48">
                                      </div>
                              ...
                              <li class="splide__slide is-visible" id="splide02-slide02" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      <div class="img-wrapper">
                                          <img src="assets/img/sample/brand/2.jpg" alt="img" class="image-block imaged w48">
                              ...
                              <li class="splide__slide is-visible" id="splide02-slide03" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      <div class="img-wrapper">
                                          <div class="iconbox bg-danger">
                              ...
                              <li class="splide__slide is-visible" id="splide02-slide04" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <div class="bill-box">
                                      <div class="img-wrapper">
                                          <div class="iconbox">
              ...
              <div class="section full mt-4 mb-3">
                  ...
                  <div class="carousel-multiple splide splide--loop splide--ltr splide--draggable is-active" id="splide03"
                      ...
                      <div class="splide__track" id="splide03-track" style="padding-left: 16px; padding-right: 16px;">
                          <ul class="splide__list" id="splide03-list" style="transform: translateX(-2628px);">
                              ...
                              <li class="splide__slide is-active is-visible" id="splide03-slide01" aria-hidden="false"
                                  tabindex="0" style="margin-right: 16px; width: 321.5px;">
                                  <a href="app-blog-post.html">
                                      <div class="blog-card">
                                          <img src="assets/img/sample/photo/1.jpg" alt="image" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide03-slide02" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <a href="app-blog-post.html">
                                      <div class="blog-card">
                                          <img src="assets/img/sample/photo/2.jpg" alt="image" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide03-slide03" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <a href="app-blog-post.html">
                                      <div class="blog-card">
                                          <img src="assets/img/sample/photo/3.jpg" alt="image" class="imaged w-100">
                              ...
                              <li class="splide__slide is-visible" id="splide03-slide04" aria-hidden="false" tabindex="0"
                                  style="margin-right: 16px; width: 321.5px;">
                                  <a href="app-blog-post.html">
                                      <div class="blog-card">
                                          <img src="assets/img/sample/photo/4.jpg" alt="image" class="imaged w-100">
          ...
          <div class="appBottomMenu">
              <a href="index.html" class="item active">
                  <div class="col">
                      <ion-icon name="pie-chart-outline" role="img" class="md hydrated" aria-label="pie chart outline">
                      </ion-icon>
                      ...
                      <div class="modal-body p-0">
                          ...
                          <ul class="listview flush transparent no-line image-listview">
                              <li>
                                  <a href="index.html" class="item">
                                      <div class="icon-box bg-primary">
                                          <ion-icon name="pie-chart-outline" role="img" class="md hydrated"
                                              aria-label="pie chart outline"></ion-icon>
                                      </div>
                                      <div class="in">
                                          Overview
                              ...
                              <li>
                                  <a href="app-components.html" class="item">
                                      <div class="icon-box bg-primary">
                                          <ion-icon name="apps-outline" role="img" class="md hydrated"
                                              aria-label="apps outline"></ion-icon>
                                      </div>
                                      <div class="in">
                                          Components
                                      </div>
                          ...
                          <ul class="listview flush transparent no-line image-listview">
                              ...
                              <li>
                                  <a href="component-messages.html" class="item">
                                      <div class="icon-box bg-primary">
                                          <ion-icon name="chatbubble-outline" role="img" class="md hydrated"
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="action-sheet-content text-center">
                              ...
                              <div>
                                  Tap <ion-icon name="share-outline" role="img" class="md hydrated"
                                      aria-label="share outline"></ion-icon> and Add to homescreen.
                              </div>
                              <div class="mt-2">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="action-sheet-content text-center">
                              ...
                              <div>
                                  Tap <ion-icon name="ellipsis-vertical" role="img" class="md hydrated"
                                      aria-label="ellipsis vertical"></ion-icon> and Add to homescreen.
                              </div>
                              <div class="mt-2">
                                  <button class="btn btn-primary btn-block" data-bs-dismiss="modal">CLOSE</button>
                              </div>
